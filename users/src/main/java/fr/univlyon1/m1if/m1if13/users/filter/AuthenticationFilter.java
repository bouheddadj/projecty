 ...
 * N'autorise l'accès qu'aux clients déjà connectés ou ayant rempli le
 * formulaire de la page <code>index.html</code>.
 * Dans ce dernier cas, le filtre crée la session / génère le token de
 * l'utilisateur, crée un objet User et l'ajoute en attribut de la session.
